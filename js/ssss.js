...
//  },
  'zh-CN': {
      ...
      image: {
        ...
        shapeThumbnail: 'Shape: Thumbnail',
        shapeNone: 'Shape: None',
        dragImageHere: '拖动图像或文本',
        dropImage: '降低图像或文本',
        selectFromFiles: '从文件选择',
        maximumFileSize: '最大文件大小',
        maximumFileSizeError: '最大文件大小超过了.',
        url: '图片路径',
        remove: '移除图片'
      },
      video: {
      ...
      help: {
        ...
        'removeFormat': '清除样式',
        'justifyLeft': '设置左对齐',
        'justifyCenter': '设置居中对齐',
        'justifyRight': '设置右对齐',
        'justifyFull': '设置两端对齐',
        'insertUnorderedList': '无序列表切换',
        'insertOrderedList': '有序列表切换',
        'outdent': '减少当前段落缩进',
        'indent': '增加当前段落缩进',
        'formatPara': 'Change current block\'s format as a paragraph(P tag)',
        'formatH1': 'Change current block\'s format as H1',
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      fontNames: [
        ...
        'Tahoma', 'Times New Roman', 'Verdana','宋体','微软雅黑'
      ],
